#
# OMNeT++/OMNEST Makefile for ceg
#
# This file was generated with the command:
#  opp_makemake -f --deep -O out -KVEINS_PROJ=/home/veins/src/veins -DVEINS_IMPORT -I. -I$$\(VEINS_PROJ\)/src -Isrc -L$$\(VEINS_PROJ\)/src -lveins$$\(D\)
#
